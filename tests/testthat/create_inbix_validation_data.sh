...
# reGAIN + SNPrank
inbix \
--regain-file ${inbix_prefix}-abs-zval.regain.tab \
--rank-by centrality \
--out ${inbix_prefix}-abs-zval
...
# reGAIN + SNPrank
inbix \
--regain-file ${inbix_prefix}-noabs-zval.regain.tab \
--rank-by centrality \
--out ${inbix_prefix}-noabs-zval
...
# reGAIN + SNPrank
inbix \
--regain-file ${inbix_prefix}-abs-beta.regain.tab \
--rank-by centrality \
--out ${inbix_prefix}-abs-beta
...
# reGAIN + SNPrank
inbix \
--regain-file ${inbix_prefix}-noabs-beta.regain.tab \
--rank-by centrality \
--out ${inbix_prefix}-noabs-beta
