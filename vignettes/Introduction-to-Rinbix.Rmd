...
The Rinbix package is a collection of functions that support the In silico research group's bioinformatics toolbox for network and machine learning analysis in bioinformatics. These functions are grouped roughly into the categories:
